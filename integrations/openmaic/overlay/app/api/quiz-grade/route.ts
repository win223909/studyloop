...
${commentPrompt ? `Grading guidance: ${commentPrompt}\n` : ''}Student answer: ${userAnswer}`;
    ...
    try {
      ...
      gradeResult = { score: parsed.score, comment: parsed.comment };
    } catch {
      // An invalid model response is an operational failure, never a grade.
      return apiError('PARSE_FAILED', 502, 'The model did not return a valid grade.');
    }
